<?php
  ...
  include_once("../includes/list-of-active-users-inc.php");
  $userdata = new UserCntr();
  $user = $userdata->get_userdata();

  $activeUsers = new activeUsersCntrl();

  $data = $activeUsers->getActiveUsers();
...
<html lang="en">
  <head>
    ...
    <title>List of Active Accounts</title>
    <!-- Bootstrap -->
                                  ...
                                  <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                                    ...
                                    <tbody>
                                      ...
                                      <?php
                                          ...
                                          foreach($data as $sd){ ?>
                                              <tr id="data_<?= $sd['id'];?>">
                                                <td> <?= ucwords(strtolower($sd['first_name']), '\',. ').' '.ucfirst($sd['last_name']); ?></td>
                                                <td> <?= ucwords(strtolower($sd['address']), '\',. '); ?></td>
                                                <td> <?= $sd['contact']; ?></td>
                                                <td> <?= $sd['email']; ?></td>
                                                <td> <?= $sd['created_at'];  ?></td>
                                                <td> <?= $sd['updated_at'];  ?></td>
